...
<<<<<<< HEAD:ZhihuDaily/Classes/AppConstants.swift
...
=======
  ...
  static var HomeTopBannerHeight: CGFloat {
    var bannerHeight: CGFloat = 150
    if Device.isPhone() && Device.size() == Size.Screen5_5Inch {
      bannerHeight += 16
    }
    return bannerHeight
  }
>>>>>>> dev:ZhihuDaily/Classes/Misc/AppConstants.swift
}